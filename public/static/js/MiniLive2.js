...
async function loadCombinedData() {
  try {
    ...
    console.log(
      'OBJ data loaded successfully:',
      objData.vertices.length,
      'vertices,',
      objData.faces.length,
      'faces.',
    )
  } catch (error) {
...
window.dhLoadingProgress = dhLoadingProgress
var dhLoadingProgress = 0

function getDhLoadingProgress() {
...
async function processVideoFrames() {
  ...
  if (
    ...
    console.log(
      'Waiting for video frames to load...',
      videoProcessor.videoFrames.length,
      videoProcessor.nbSampleTotal,
    )
